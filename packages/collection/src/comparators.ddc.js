define(['dart_sdk'], function(dart_sdk) {
  ...
  equality.EqualityBy$ = dart.generic((E, F) => {
    ...
    (EqualityBy.new = function(getKey, inner = C0 || CT.C0) {
      this[_getKey] = getKey;
      this[_inner] = inner;
      ;
